...
`Oates, C.J., Dondelinger, F., Bayani, N., Korkola, J., Gray, J.W., Mukherjee, S.: Causal network inference using biochemical kinetics. Bioinformatics 30(17), i468¡Vi474 (2014)`
...
- main_ICHEMA.m with function main_ICHEMA(DATA, node, parents, inhibition_vec, n_iterations). This function takes the following arguments:
	...
	- inhibition_vec : a vector with 0 (activation) and 1 (inhibition) flags that define the type of term for each parent in vector 'parents'.
