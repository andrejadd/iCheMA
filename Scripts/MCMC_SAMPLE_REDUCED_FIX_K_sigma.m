...
function [SAMPLE] = MCMC_SAMPLE_REDUCED_FIX_K_sigma(node,parents,inhibition_vec,prod_ind,DATA,n_iterations,K_star,sigma_star)
    ...
    for t=2:(n_iterations+1)
        ...
        % P(V|delta,sigma^2,y,K) = N(mu_gibbs,Sigma_gibbs)
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
        % Do not re-sample sigma

        % Sufficient statistics for delta:
        % P(delta|V,sigma^2,y,K) = IG(a,b)
